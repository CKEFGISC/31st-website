  ...
  return (
    <section id="alive" className="events-page-section">
      <div className="container">
        <SectionTitle>未來活動</SectionTitle>
        <EventIntro
          imgSrc="/images/events/2024_welcoming.jpg"
          imgText="2024 聯合迎新"
          title="迎新"
          time="十月"
        ...
        />
        <EventIntro
          imgSrc="/images/events/2025_winter.jpg"
          imgText="2025 聯合寒訓"
          title="寒訓"
          time="一～二月"
        ...
        />
        <EventIntro
          imgSrc="/images/events/2025_exhibition.jpg"
          imgText="2025 聯合社展"
          title="社展"
          time="五～六月"
          description="展中，我們將展現我們社團的學術力，發揮學術性社團的專長！"
        />
        <SectionTitle>已結束活動</SectionTitle>
        <EventIntro
          imgSrc="/images/events/2025_tea.jpg"
          imgText="2025 聯合茶會"
          title="茶會"
          time="七月"
        ...
        />
        <EventIntro
          imgSrc="/images/events/2025_summer.jpg"
          imgText="2025 聯合暑訓"
          title="暑訓"
          time="八月"
